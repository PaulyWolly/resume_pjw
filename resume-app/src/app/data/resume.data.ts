...
export const RESUME: Resume = {
  ...
  experience: [
    ...
    },
    {
      ...
      endDate: '11/2016',
      highlights: [
        'Designed and developed visually appealing, responsive web applications utilizing HTML5, CSS3, JavaScript, and modern front-end libraries (Angular, React, Vue.js).',
        'Collaborated closely with UX/UI designers to translate design concepts and interactive wireframes into pixel-perfect, highly intuitive user interfaces.',
        'Implemented accessibility standards (WCAG) and user-centered design principles to significantly enhance application usability and cross-browser compatibility.',
        'Managed application state and client-side routing to deliver scalable, high-performance, and easily maintainable front-end architectures.',
      ],
    },
    {
      ...
      endDate: '12/2015',
      highlights: [
        'Designed and developed visually appealing, interactive web applications utilizing HTML5, CSS3, JavaScript, and modern front-end libraries (Angular, React, Vue.js).',
        'Ensured flawless cross-browser compatibility and responsive UI layout design to deliver exceptional user experiences across diverse desktop and mobile devices.',
        'Collaborated closely with UX/UI designers to seamlessly translate design wireframes and concepts into intuitive, pixel-perfect user interfaces.',
      ],
    },
    {
      title: 'Engineer / Programmer Analyst / Web Developer',
      company: 'Qualcomm',
      arrangement: 'FTE / Onsite',
      startDate: '12/2009',
      endDate: '10/2014',
